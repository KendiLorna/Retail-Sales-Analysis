...
There,I created new columns by splitting the purchase address column into City & State(due to similar cities in different states), State, and Street name and Zip code.
